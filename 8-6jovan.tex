...
\end{align*}
% >>>>>> ANNEX D (cut-sheet v2): generating reciprocals, sums of powers, inverse-square reciprocity — block commented out below, pointer left in text <<<<<<
\textit{(Generating reciprocals, sums of powers, inverse-square reciprocity --- the full working is set out in Annexe D.)}
...
\newpage
% >>>>>> ANNEX D (cut-sheet v2): Euler's integral approach to the Basel problem — block commented out below, pointer left in text <<<<<<
\textit{(Euler's integral approach to the Basel problem --- the full working is set out in Annexe D.)}
...
% >>>>>> ANNEX D (cut-sheet v2): exponential hierarchies and the 3D multipole optimization — block commented out below, pointer left in text <<<<<<
\textit{(Exponential hierarchies and the 3D multipole optimization --- the full working is set out in Annexe D.)}
...
% \newpage
% >>>>>> end of annexed block <<<<<<
% >>>>>> ANNEX D (cut-sheet v2): hyperbolic manifolds, Waring's problem and reciprocal polygonal numbers — block commented out below, pointer left in text <<<<<<
\textit{(Hyperbolic manifolds, Waring's problem and reciprocal polygonal numbers --- the full working is set out in Annexe D.)}
...
A well-worn study filled with chalkboards scrawled with equations, a half-empty bottle of scotch, and an air thick with intellectual rivalry. Willard Jones and Ernest Olber sit across from each other, while Jovannah lounges between them, feigning casual disinterest but secretly enjoying the sparring.
...
Willard Jones, adjusting his glasses with an air of quiet authority: \textit{"It’s hardly a contest, Jovannah. Spherical harmonics are the cornerstone of so many fundamental fields—quantum mechanics, electromagnetism, even the cosmic microwave background."} \newline
...
Ernest Olber, smirking, pouring himself another drink: \textit{"Oh, come now, Willard. Always the formalist. But tell me—how do you solve wave propagation in a circular membrane? Bessel functions. How do you handle cylindrical waveguides, optical resonators? Bessel functions."} \newline
...
Willard, scoffing, leaning forward: \textit{"Idealized models? Ernest, tell me—when was the last time you tried modeling atomic orbitals using Bessel functions? Or predicting large-scale cosmic anisotropies? Spherical harmonics describe the very structure of the universe."}
...
Willard, narrowing his eyes, muttering: \textit{"That’s beside the point…"}

\bigskip

Ernest, grinning: \textit{"No, it’s exactly the point. And admit it, Willard—you don’t actually hate Bessel functions. You just can’t stand that they’re just as important as your precious harmonics."}
...
Willard sighs, Ernest chuckles, and Jovannah leans back, satisfied. The debate will never end, but that’s exactly why it’s worth having.
%%%%%%%%%%%%%%%%%%%%%%%%

\section*{On Cosmic Multipoles and Charge Moments}

Willard Jones: 
"Alright, Ernest, I understand that the CMB power spectrum represents temperature fluctuations across the sky, but I keep thinking about multipoles in the context of electrostatics: those dipoles, quadrupoles, and so on. Can we think of these CMB multipoles in the same way?"
...
Willard nods. "So the dipole is just a shift due to motion. What about the first real structure in the fluctuations?"
...
Willard ponders. "So just like how a dipole in a charge system represents a charge separation, the CMB dipole represents motion? And just like how a quadrupole represents opposite dipoles, the CMB quadrupole represents the largest real temperature fluctuations?"
...
"But why multipoles?" Willard asks. "How do they emerge mathematically?"
...
Willard's eyes widen. "The universe itself is like an electric field, carrying an imprint of its earliest fluctuations!"
...
Jovannah, swirling her drink lazily: \textit{"So tell me, gentlemen: who is it exactly that owns the truth in mathematics? The one who discovers it first, or the one who understands it best?"}

\bigskip

Willard, without hesitation: \textit{"Truth is not owned, but grasped. By those willing to chase it with absolute clarity."} He gestures toward the board, eyes narrowed. \textit{"Rigor, derivation, and proof is the only measure of true understanding."}

\bigskip

Ernest, smirking: \textit{"Ah, but clarity is an illusion, Willard. Mathematics is as much about intuition as it is about proof. You can’t sit around proving every step when the world moves at the speed of light. Sometimes you leap. Sometimes you trust your instincts."}

\bigskip

Willard, scoffing: \textit{"Ah, ‘intuition.’ A fine excuse for sloppiness. That’s how we get your half-baked physics papers masquerading as mathematics. That’s how errors creep in, how rigor is abandoned for convenience."}

\bigskip

Ernest, riled and amused in equal portions: \textit{"Yes, yes. And yet, whose work has applications beyond pure abstraction? Yours, trapped in a world of ideals? Or mine, where the equations breathe in reality, shaping actual phenomena?"} He taps the board. \textit{"These harmonics? They aren’t just pretty functions. They dictate how sound waves move, how galaxies form. They \textbf{do} something, Willard."}

\bigskip

Willard, feigning coolness: \textit{"And you think that justifies sloppy thinking? That the mere presence of applicability validates any loose approximation you see fit to take?"}

\bigskip

Ernest, feigning grinning: \textit{"It justifies the fact that I don’t waste my time chasing ghosts. You hide in the ivory tower because you fear being wrong. I build models because I know we must be."}

\bigskip

Jovannah, eyes a glinting: \textit{"So what we have here is the eternal struggle. Das Ein and Das Man."} She gestures grandly. \textit{"Willard, the idealist, the one who seeks truth without compromise, without shortcuts, who would rather be alone with his principles than risk contamination by the crowd."}

\bigskip

Willard, blinking, uncertain: \textit{"That’s not—"}
...
Silence. Willard stares at the board. Ernest swirls his glass.
...
Willard tightens his grip on the chalk. Ernest takes another sip of whiskey. Neither speaks.

\bigskip

\textit{And Jovannah, knowing she has won a far greater game than mathematics, sits back drinking in her moment.} Ernest takes his leave.

\smallskip

% >>>>>> ANNEX D (cut-sheet v2): spherical harmonics, isoperimetric multipoles and the power mean of the CMB — block commented out below, pointer left in text <<<<<<
\textit{(Spherical harmonics, isoperimetric multipoles and the power mean of the CMB --- the full working is set out in Annexe D.)}
